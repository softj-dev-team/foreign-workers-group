                ...
                return e = t, (n = [{
                    ...
                    value: function (t, e) {
                        ...
                        return (n = t, i.a.Deferred((function (t) {
                            ...
                            o.beforeCommand(), "function" == typeof e ? e(t) : ("string" == typeof e && t.attr("data-filename", e), t.css("max-width", '100%')), t.show(), o.getLastRange().insertNode(t[0]), o.setLastRange(yt.createFromNodeAfter(t[0]).select()), o.afterCommand()
                        })).fail((function (t) {
